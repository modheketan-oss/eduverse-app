...
import { Briefcase, TrendingUp, Award, PlayCircle, ArrowRight, Zap, Target, Linkedin } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-center">
                            <div className="flex justify-between items-start">
                                ...
                                {course.isPremium && <span className="text-[10px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded font-bold">PRO</span>}
                            </div>
